...
function UserForm() {
    ...
    //         totalTravelDays: Number(totalTravelDays),
    //         user_scenery_requirement,
    //         user_activity_preference,
    //         user_weather_preference: {
    //             avg_temp: user_weather_preference.avg_temp
    //                 ? Number(user_weather_preference.avg_temp)
    //                 : null,
    //             humidity: user_weather_preference.humidity
    //                 ? Number(user_weather_preference.humidity)
    //                 : null,
    //             weather_type: user_weather_preference.weather_type || null,
    //         },
    //         travel_month,
    //     };
    ...
    //     try {
    //         const res = await fetch("http://localhost:5000/api/userPreference", {
    //             method: "POST",
    ...
    // const showMonth =
    //     user_weather_preference.avg_temp ||
    //     user_weather_preference.humidity ||
    //     user_weather_preference.weather_type;
    ...
    return (
        <div className="max-w-2xl mx-auto bg-white shadow-md rounded-2xl p-6 space-y-6">
            ...
            <div className="space-y-2">
                <label className="font-medium">Budget (VND)</label>
